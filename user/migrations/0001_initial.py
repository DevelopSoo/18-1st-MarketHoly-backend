    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accumulated_rate', models.DecimalField(decimal_places=1, max_digits=2, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saved_item', models.ManyToManyField(to='product.Product')),
            ],
            options={
                'db_table': 'users',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('money', models.DecimalField(decimal_places=3, max_digits=8)),
